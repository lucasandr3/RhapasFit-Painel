...
<div class="content">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <a data-toggle="modal" data-target="#modalDespesaRecorrente" class="btn btn-success mb-3" style="border-radius:5px;color:#FFF;">
    ...
    <!-- modal -->
    <div class="modal fade" id="modalDespesaRecorrente" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
          ...
          <form action="<?php echo BASE_URL ?>saida/addReco" method="POST">
                <div class="row">
