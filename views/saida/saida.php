...
<div class="content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="div-finan">
                        <div>
                            ...
                            Adicionar despesa &nbsp;&nbsp; <i class="fa fa-plus"></i>
                            </a>
                        </div>
                        <div style="margin-top:8px;"><h5 id="en-mes-s">Saídas do Mês de <?=strftime('%B', strtotime('F'))?></h5></div>
                        <?php
                            $ano = date('Y');
                        ?>
                        <div>
                            <select class="form-control" name="mesSelect" id="mesDesSelect" style="border: 1px solid #999;border-radius: 5px;">
                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0"
                            ...
                            <tbody id="bodytabled">
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:bold;color:red;">R$ <?=number_format($despesa['valor'],2,',','.')?></td>
                                    <td><?=date('d/m/Y', strtotime($despesa['data_d']))?></td>
                                    <td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-header bg-success">
            <h5 class="modal-title" id="exampleModalLabe">Cadastro de despesa</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <i class="ti-close"></i>
            </button>
        </div>
        <div class="modal-body">
        <form action="<?=BASE_URL ?>saida/add" method="POST">
        <div class="row">
