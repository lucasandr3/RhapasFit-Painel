...
class Delivery extends Model {
	...
	public function getAll($id_company, $bairro = null)
	{
		$array = [];

		if($bairro) {
			$sql ="SELECT * FROM bairros WHERE id_company = :idc AND nome_bairro LIKE :b";
			$sql = $this->db->prepare($sql);
			$sql->bindValue(':b', '%'.$bairro.'%');
			$sql->bindValue(':idc', $id_company);
			$sql->execute();
		} else {
			$sql ="SELECT * FROM bairros WHERE id_company = :idc";
			$sql = $this->db->prepare($sql);
			$sql->bindValue(':idc', $id_company);
			$sql->execute();
		}
